...
class CausalCNNModule(torch.nn.Module):
    """
    Encoding module of a time series using a causal CNN: the computed representation is
    ...
    def __init__(self, in_channels, channels, depth, reduced_size, out_channels, kernel_size):
        super(CausalCNNModule, self).__init__()
